...
public:
	...
	TSubclassOf<UPlayerLable> PlayerLableClass;
...
protected:
	...
	UFUNCTION()
	void CreateAndAddPlayerLable(const FLobbyPlayerInfo& PlayrInfo);
...
private:
	...
	UPlayerLable* FindPlayerLable(const FString& Username);
};
